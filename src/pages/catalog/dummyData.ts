export const signLanguages = [
    {
        ...
        exercises: [
            { id: 1, title: "Basic Signs", word: 'Apple', level: "Beginner" },
            { id: 2, title: "Finger Spelling", word: 'Homework', level: "Intermediate" },
            { id: 3, title: "Conversational ASL", word: 'Refrigerator', level: "Advanced" },
        ],
    },
    {
        name: "BSL",
        ...
        exercises: [
            { id: 4, title: "Basic Signs", word: 'Apple', level: "Beginner" },
            { id: 5, title: "Finger Spelling", word: 'Homework', level: "Intermediate" },
            { id: 6, title: "Conversational BSL", word: 'Refrigerator', level: "Advanced" },
        ],
    },
    {
        name: "FSL",
        ...
        exercises: [
            { id: 7, title: "Basic Signs", word: 'Maison', level: "Beginner" },
            { id: 8, title: "Finger Spelling", word: 'Devoirs', level: "Intermediate" },
            { id: 9, title: "Conversational FSL", word: 'Réfrigérateur', level: "Advanced" },
        ],
    },
    {
        name: "ISL",
