  ...
  return (
    <div className="full max-w-6xl items-center m-auto flex flex-col gap-10">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className={`w-50 absolute right-20 bottom-10 ${webcamRunning ? 'visible' : 'hidden'} `}>
            disclaimer: please slowely put your open palm in the frame to get detected first before u show the sign
          </div>
